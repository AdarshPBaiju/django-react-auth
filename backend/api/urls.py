...
from .views import MyTokenObtainPairView, RegisterView, dashboard, LogoutView,user_data, ResetPassword, VerifyResetPasswordLink, ConfirmResetPassword, VerifyEmailView
