...
function RegisterPage() {
  ...
  return (
    <section className="h-100 mt-5 mb-5">
                  ...
                  <div className="card-body p-4 p-lg-5 text-black">
                    <form onSubmit={handleSubmit}>
                      ...
                      <div className="form-outline mb-4">
                        <input type="email" id="email" className="form-control form-control-lg" placeholder="Email Address" onChange={e => setEmail(e.target.value)} />
                      </div>
                      ...
                      <p className="mb-5 pb-lg-2" style={{ color: '#393f81' }}>
                        ...
                        <Link to="/login" style={{ color: '#393f81' }} className='ml-3'>Login Now</Link>
                      </p>
